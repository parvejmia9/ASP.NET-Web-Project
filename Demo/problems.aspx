<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="problems.aspx.cs" Inherits="Demo.problems" %>
...
.card{
    ...
    <div class="first container">
        <div class="row">
            <div runat="server" id="hid" class="col-md-5">
                    ...
                    <div class="validate-form card-body">
                        ...
                        <div class="validate-form row mt-3">
                            <div class="mx-auto col-4">
                                <asp:Button ID="Button1" class="btn abcd btn-block btn-danger" runat="server" Text="Remove" OnClick="Button1_Click" />
                            </div>
                        </div>
